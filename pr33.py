...
class MyApp(App):
    ...
    def build(self):
        ...
        self.TextInput1 = TextInput(text = "Код цвета")
    ...
    def TextInput1_Code(self, instance):
        ...
        self.update_TextInput1()

    def update_TextInput1(self):
        self.TextInput1.text = self.Label_Code    
